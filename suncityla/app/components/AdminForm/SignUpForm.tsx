...
export default function SignUpForm() {
    const { register, handleSubmit, formState : {errors} } = useForm<AdminRegistrationFormData>({
    ...
    return (
            <form onSubmit={handleSubmit(onSubmit)} className="regForm">
                ...
                <div>
                    <h2 className="text-center">Do you already have an account? <Link href="/admins/signin" className=" font-semibold text-white"> please Login</Link></h2>
                </div>
            </form>
    )
}